					...
					<div class="row">
						<!-- Content -->
							<section>
                                ...
                                $result = query($mysqli,'select PRODUITS.id_prod as id,PRODUITS.Libelle as lib,PRODUITS.Photo as photo, PRODUITS.Descriptif as descr from PRODUITS,RUBRIQUES,APPARTIENT where APPARTIENT.id_prod = PRODUITS.id_prod and APPARTIENT.id_rub = RUBRIQUES.id_rub and libelle_rub = \'Table\'');
